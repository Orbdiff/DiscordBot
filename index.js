...
const DEFAULT_COOLDOWN_TIME = 3 * 24 * 60 * 60 * 1000; // 3 días
...
client.on("interactionCreate", async (interaction) => {
    ...
    // Bloquea si el usuario tiene cooldown
    ...
    // Manda el mensaje mencionando al usuario y al rol extra
    await channel.send({
